...
public class Drivetrain extends PedrioSubsystem {
    ...
    public MecanumDrive drive = new MecanumDrive(robot.FrontLeftMotor,robot.FrontRightMotor,robot.BackLeftMotor,robot.BackRightMotor);
    ...
    private HolonomicOdometry odo = new HolonomicOdometry(
            ...
            (double) 16 / 12 / 3,  //change this to match your robots
            0
            // and this they both in meters
    );
